...
public class CodeRedCheckTest {
   ...
   public void codeRedCheckResponseTest() throws Exception {
       ...
       MockHttpServletRequestBuilder httpRequest = MockMvcRequestBuilders.post("/check");
       ...
       assertEquals("unsupported request", response.getContentAsString());
   }
}
